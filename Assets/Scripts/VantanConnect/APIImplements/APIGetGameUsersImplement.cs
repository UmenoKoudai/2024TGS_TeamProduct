...
namespace VTNConnect
{
    ...
    public class APIGetGameUsersImplement
    {
        ...
        {
            string request = String.Format("{0}/gameusers/active", VantanConnect.Environment.APIServerURI);
        ...
        {
            string request = String.Format("{0}/gameusers/{1}", VantanConnect.Environment.APIServerURI, gameHash);
            string json = await Network.WebRequest.GetRequest(request);
